...
- Operatorn `in`kan komma väl till hands i lösningen.
...
### Övning 3: Frekvens, total och procent
...
2. **Beräkna procentuell förekomst**: Skapa en funktion `char_frequency(s)` som:
...
### Övning 15: Filtrera strängar med sökord
