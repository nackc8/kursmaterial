...
### Övning 1: Hundålder till människoår (med `doctest`)
...
### Övning 2: Rövarspråket (med `unittest`)
...
### Övning 3: Primtal i ett intervall (med `pytest`)
...
### Övning 4: Basketpoäng (med `doctest`)
...
### Övning 5: Summan av jämna tal (med `doctest`)
...
### Övning 6: Vänd en sträng (med `unittest`)
...
### Övning 7: Beräkna fakultet (med `pytest`)
...
### Övning 8: Räkna vokaler i en sträng (med `doctest`)
